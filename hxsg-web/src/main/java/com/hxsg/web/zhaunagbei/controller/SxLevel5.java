package com.hxsg.web.zhaunagbei.controller;

import com.hxsg.core.Dao.*;
import com.hxsg.core.po.WuQiDetail;
import com.hxsg.web.CommonUtil.CommonUtilAjax;
import com.hxsg.web.CommonUtil.ZbDetail.ZbShuXing;
                ...
                switch (pinzhi) {
                    ...
                    case 1:{
                        ...
                        if (gl >70) {
                            ...
                            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", "恭喜你装备升级为3星", request, response);
                        }else{
                            ...
                            if (level == 1) {
                                ...
                                wqdm.updateByPrimaryKeySelective(wadl);
                                com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", "升级失败，降星到1星", request, response);
                            }
                            if (level == 2) {
                                com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", "升级失败，但是没有降星", request, response);
                    ...
                    case 4:{
                        ...
                        if (gl > 70) {
                            ...
                            wqdm.updateByPrimaryKeySelective(wadl);
                            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", "恭喜你装备升级为2星", request, response);
                        }else{
                            int a = (int) (Math.random() * 2);
                            int b = (int) (Math.random() * 3);
                            Integer level = Integer.parseInt(wadl.getLevel()) - a;
