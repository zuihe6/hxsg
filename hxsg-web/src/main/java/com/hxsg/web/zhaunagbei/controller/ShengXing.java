                ...
                switch (pinzhi) {
                    ...
                    case 1:{
                        ...
                        if (gl >90) {
                            ...
                            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", "恭喜你装备升级为4星", request, response);
                        }else{
                            ...
                            if (level == 2) {
                                ...
                                wqdm.updateByPrimaryKeySelective(wadl);
                                com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", "升级失败，降星到2星", request, response);
                            }
                            if (level == 3) {
                                wadl.setLevel(level.toString());
                                ...
                                com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", "升级失败，降星到3星", request, response);
                    ...
                    case 2:{
                        ...
                        if (gl > 90) {
                            ...
                            wqdm.updateByPrimaryKeySelective(wadl);
                            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", "恭喜你装备升级为5星", request, response);
                        }else{
                            int a = (int) (Math.random() * 2+1);
                            int b = (int) (Math.random() * 3);
                            Integer level = Integer.parseInt(wadl.getLevel()) - a;
