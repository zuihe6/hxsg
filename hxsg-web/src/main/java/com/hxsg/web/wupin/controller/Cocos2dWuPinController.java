package com.hxsg.web.wupin.controller;

import com.hxsg.core.po.*;
import com.hxsg.web.CommonUtil.CommonUtilAjax;
import com.hxsg.web.vo.IndexFuJiangVo;
import com.hxsg.web.vo.ZaWuDetailVo;
import com.hxsg.web.vo.ZhuangBeiDetailVo;
import com.hxsg.web.wupin.service.Cocos2dUserWuPinService;
import com.hxsg.web.wupin.service.Cocos2dZhuangBeiToRole;
import com.hxsg.web.wupin.service.cocos2dWuPinService;
...
public class Cocos2dWuPinController {
    ...
    public String wupin(RoleWuPin re, HttpSession session, HttpServletRequest request, HttpServletResponse response){
        try{
            ...
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxArray(obj,request, response);
        }catch (Exception e){
            logger.error("控制层--cocos2dWuPin/wupin获取角色物品："+e.getMessage());
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", new RoleWuPin(), request, response);
        }
        return null;
    }
    //物品-杂物分类
    ...
    public String wupinDescribe( @RequestParam(value = "id", required = false) Integer id,
        ...
        try{
            ...
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", zu, request, response);
        }catch (Exception e){
            logger.error("控制层--cocos2dWuPin/wupinDescribe获取物品详情："+e.getMessage());
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", new ZaWuMiaoShu(), request, response);
        }
        return null;
    }
    //物品-宝石分类
    ...
    public String baoshi(
        ...
        try{
            ...
            bc.setRoleid(roleId);
            List<com.hxsg.web.vo.ZaWuDetailVo> libaoshi=cocos2dwupinservice.queryWuPinByBaoShi(roleId, roleName);
    ...
    public String baoshiDescribe(@RequestParam(value = "id", required = false) Integer id,
        ...
        try{
            ...
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", baoshi, request, response);
        }catch (Exception e){
    ...
    public String queryZhuangBeiDetail(ZhuangBeiDetailVo zb,
        ...
        try{
            ...
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", zv, request, response);
        }catch (Exception e){
    ...
    public String getBaoShiByZhaungbei(@RequestParam(value = "id", required = false) Integer id,
        ...
        try{
            ...
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", lir, request, response);
        }catch (Exception e){
    ...
    public String mosaicGemtoZhuangBei(@RequestParam(value = "bsId", required = false) Integer bsId,
        ...
        try{
            ...
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg",result, request, response);
        }catch (Exception e){
            logger.error("控制层--cocos2dWuPin/getBaoShiByZhaungbei获取可以被该宝石镶嵌的装备："+e.getMessage());
        }
        return null;
    ...
    public String userDaoJu(@RequestParam(value = "wupinId", required = false) Integer wupinId,
        ...
        try{
            ...
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg","已经学习过该技能了，不需要再次学习", request, response);
        }
        catch (Exception e){
    ...
    public String peiYangFuJiang(@RequestParam(value = "fuId", required = false) Integer fuId,
        ...
        try{
            ...
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg",ot, request, response);
        }catch (Exception e){
    ...
    public String getJiNengShuList(@RequestParam(value = "id", required = false) Integer id,
        ...
        try{
            ...
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg",lisk, request, response);
        }catch (Exception e){
    ...
    public String getXinFaFuJiangs(@RequestParam(value = "wupinId", required = false) Integer wupinId,
        ...
        try{
            ...
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg",lifu, request, response);
        }catch (Exception e){
