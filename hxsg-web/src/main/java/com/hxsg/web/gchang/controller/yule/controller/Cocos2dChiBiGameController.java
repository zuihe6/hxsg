package com.hxsg.web.gchang.controller.yule.controller;

import com.hxsg.web.gchang.controller.yule.service.Cocos2dGcService;
import com.hxsg.web.gchang.controller.yule.service.Cocos2dGcYuLeChiBiGameService;
import com.hxsg.web.gchang.controller.yule.service.impl.Cocos2dGcYuLeChiBiGameServiceImpl;
import com.hxsg.core.po.ChibiYazhuDetail;
import com.hxsg.web.CommonUtil.CommonUtilAjax;
import com.hxsg.web.vo.ChiBiMsgVo;
...
public class Cocos2dChiBiGameController {
    ...
    public String queryCasinoMsg(HttpServletRequest request,HttpServletResponse response){
        try{
            com.hxsg.web.vo.ChiBiMsgVo cg= cocos2dgcyulechibigameservice.loadChiBiDetail(Cocos2dGcYuLeChiBiGameServiceImpl.num);
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("msg", cg, request, response);
        }catch (Exception e){
    ...
    public String Casinotime(HttpServletRequest request,HttpServletResponse response)throws Exception {
        try {
            com.hxsg.web.CommonUtil.CommonUtilAjax.sendAjaxList("times", Cocos2dGcYuLeChiBiGameServiceImpl.CHIBITIME,request,response);
        } catch (Exception e) {
